 ...
 */
case class WholeStageCodegenExec(child: SparkPlan, override val metrics: Map[String, SQLMetric])
 ...
 */
case class InputAdapterExec(child: SparkPlan) extends UnaryExecNode {
