 ...
 * Replacement of [[org.apache.spark.sql.catalyst.expressions.FromAvro]].
 */
case class AvroDataToCatalyst(child: Expression) extends UnaryExpression with ExpectsInputType {
...
/**
 * [[org.apache.spark.sql.avro.CatalystDataToAvro]].
 * Replacement of [[org.apache.spark.sql.catalyst.expressions.ToAvro]].
 */
