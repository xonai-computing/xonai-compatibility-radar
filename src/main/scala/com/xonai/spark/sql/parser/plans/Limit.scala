...
/**
 * [[org.apache.spark.sql.execution.LimitExec]].
 */
 ...
 */
case class CollectLimitExec(limit: Int, child: SparkPlan, offset: Int) extends LimitExec {
 ...
 */
case class LocalLimitExec(limit: Int, child: SparkPlan) extends LimitExec {
 ...
 */
case class GlobalLimitExec(limit: Int, child: SparkPlan, offset: Int) extends LimitExec {
