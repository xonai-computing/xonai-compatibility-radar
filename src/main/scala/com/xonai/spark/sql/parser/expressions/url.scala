 ...
 */
case class UrlEncode(child: Expression) extends UnaryExpression with ExpectsInputType {
 ...
 */
case class UrlDecode(child: Expression) extends UnaryExpression with ExpectsInputType {
 ...
 */
case class ParseUrl(children: IndexedSeq[Expression]) extends Expression with ExpectsInputType {
